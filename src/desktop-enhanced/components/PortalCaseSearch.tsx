...
interface PortalCaseSearchProps {
    isInsideCase?: boolean;
    caseNum?: string;
}

export const PortalCaseSearch: React.FC<PortalCaseSearchProps> = ({ isInsideCase, caseNum }) => {
    ...
    useEffect(() => {
        if (isInsideCase && caseNum) {
            const matches = results.filter(r => r.caseNumber.includes(caseNum));
            setVisibleResults(matches);
            setSearchTrigger(caseNum);
        }
    }, [isInsideCase, caseNum, results]);
    ...
    const finalResults = useMemo(() => {
        ...
        return current;
    }, [visibleResults, quickFilter, statusFilter, typeFilter]);
    ...
    return (
        <div className={styles.view}>
                ...
                <div className={styles.triggeredSearchRow}>
                    <div className={styles.searchBar}>
                        <TriggeredSearch
                            ...
                            placeholder="Enter case name or ID to search..."
                        />
                    </div>
                </div>
            )}
            ...
            <div className={styles.tableWrapper}>
                {(!isInsideCase && !searchTrigger) ? (
                    <div className={styles.empty}>
                        <span className="material-symbols-rounded">search</span>
                        <p>Enter a case name or ID to see results.</p>
                    </div>
                ) : (
                    <PortalDataTable 
                        data={finalResults} 
                        ...
                        emptyState={<div className={styles.empty}>No matching cases found.</div>}
                    />
                )}
            </div>
